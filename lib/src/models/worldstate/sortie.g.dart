...
Sortie _$SortieFromJson(Map json) => $checkedCreate(
      'Sortie',
      json,
      ($checkedConvert) {
        final val = Sortie(
          ...
          variants: $checkedConvert(
              ...
              (v) => (v as List<dynamic>)
                  .map((e) =>
                      Variant.fromJson(Map<String, dynamic>.from(e as Map)))
                  .toList()),
          missions: $checkedConvert(
              'missions',
              (v) => (v as List<dynamic>)
                  .map((e) =>
                      Mission.fromJson(Map<String, dynamic>.from(e as Map)))
                  .toList()),
