...
Map<String, dynamic> _$PetResourcesToJson(
  PetResources instance,
) => <String, dynamic>{
...
PetResourcesBuildable _$PetResourcesBuildableFromJson(
  Map json,
) => $checkedCreate('PetResourcesBuildable', json, ($checkedConvert) {
