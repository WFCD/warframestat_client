...
Primary _$PrimaryFromJson(Map json) => $checkedCreate('Primary', json, (
  $checkedConvert,
) {
  final val = Primary(
...
PrimaryBuildable _$PrimaryBuildableFromJson(
  Map json,
) => $checkedCreate('PrimaryBuildable', json, ($checkedConvert) {
...
Map<String, dynamic> _$PrimaryBuildableToJson(
  PrimaryBuildable instance,
) => <String, dynamic>{
  'uniqueName': instance.uniqueName,
  'name': instance.name,
  if (instance.description case final value?) 'description': value,
